...
module.exports = {
  getSupplier: async (req, res) => {
    try {
      ...
      if (rowCount === 0) return tmplt.res404("Suppliers cannot be retrieved", res);
  ...
  getSupplierParams: async (req, res) => {
    try {
      ...
      if (rowCount === 0) return tmplt.res404("Supplier cannot be retrieved", res);
      return tmplt.res200payload(rows, res);
    } catch (err) {
      return tmplt.res500(err, res);
    }
  ...
  postSupplier: async (req, res) => {
    try {
      ...
      if (rowCount === 0) return tmplt.res404("Supplier cannot be created", res);
  ...
  updateSupplier: async (req, res) => {
    ...
    try {
      ...
      if (rowCount === 0) return tmplt.res404("Supplier cannot be updated", res);
  ...
  deleteSupplier: async (req, res) => {
    ...
    try {
      ...
      if (rowCount === 0) return tmplt.res404("Supplier cannot be deleted", res);
      return tmplt.res200payload(rows[0], res);
    } catch (err) {
      return tmplt.res500(err, res);
    }
